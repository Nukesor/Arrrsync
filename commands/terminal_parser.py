...
cd_parser.add_argument('path', nargs='*',
                       default=['.'], type=str, help='A directory you want to cd into.')

# get Parser
get_parser = ThrowingParser(description='Parser for get', add_help=False)
get_parser.add_argument('path', nargs='*', default=['.'],
                        type=str, help='The files you want to get.')
get_parser.add_argument('-t', '--target', default='.', type=str,
                        help='The file/directory your files will be downloaded to.')
...
push_parser.add_argument('-t', '--target', default='.', type=str,
                         help='The file/directory you want to push to.')
...
ls_parser.add_argument('path', nargs='*', default=['.'], type=str,
                       help='Specify a directory or file you want to inspect.')

# isdir Parser
isdir_parser = ThrowingParser(description='Parser for ls', add_help=False)
isdir_parser.add_argument('path', nargs='*', default=['.'], type=str,
                          help='A directory you want to cd into.')
