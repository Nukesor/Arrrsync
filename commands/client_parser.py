...
client_parser.add_argument('--password', type=str, help='The password for your identityfile, if no ssh-agent is running. Can be supplied interactively later')
client_parser.add_argument('-p', '--port', type=int, help='Port')
client_parser.add_argument('-k', '--identityfile', type=str, help='The keyfile you use for connection')
